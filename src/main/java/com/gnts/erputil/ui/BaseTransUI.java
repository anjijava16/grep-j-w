...
abstract public class BaseTransUI implements ClickListener {
	/**
	 * 
	 */
	...
	public HorizontalLayout hlCmdBtnLayout1 = new HorizontalLayout();
	...
	public BaseTransUI() {
		...
		hlPageHdrContainter.addComponent(btnPrint);
		hlPageHdrContainter.setComponentAlignment(btnPrint, Alignment.MIDDLE_RIGHT);
		...
		hlCmdBtnLayout1.addComponent(btnAdd);
		hlCmdBtnLayout1.setComponentAlignment(btnAdd, Alignment.MIDDLE_LEFT);
		hlCmdBtnLayout1.addComponent(btnEdit);
		hlCmdBtnLayout1.setComponentAlignment(btnEdit, Alignment.MIDDLE_LEFT);
		hlCmdBtnLayout1.addComponent(btnAuditRecords);
		hlCmdBtnLayout1.setComponentAlignment(btnAuditRecords, Alignment.MIDDLE_LEFT);
		hlCmdBtnLayout1.addComponent(btnDownload);
		hlCmdBtnLayout1.setComponentAlignment(btnDownload, Alignment.MIDDLE_RIGHT);
		hlCmdBtnLayout1.setHeight("35px");
		hlCmdBtnLayout1.setWidth("100%");
		hlCmdBtnLayout1.setExpandRatio(btnAuditRecords, 1);
		hlCmdBtnLayout1.addStyleName("topbarthree");
		hlCmdBtnLayout1.setMargin(new MarginInfo(false, false, false, true));
		hlCmdBtnLayout.setHeight("35px");
		hlCmdBtnLayout.setWidth("100%");
		// Add child containers to the Root container
		hlCmdBtnLayout.addComponent(GERPPanelGenerator.createPanel(hlCmdBtnLayout1));
		hlPageRootContainter.addComponent(hlUserIPContainer);
		hlPageRootContainter.addComponent(hlSrchContainer);
		hlPageRootContainter.addComponent(hlCmdBtnLayout);
