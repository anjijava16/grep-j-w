...
public class SyndConstructionBuilding implements ClickListener {
...
.getBean("newPlinth");
	...
	private String strEvaluationNo = "SYN_CONSBUILD_",strXslFile="SyndConstBuilding.xsl", evalNumber, customer, propertyType;
	// pagination
			private int total = 0;
	// for table panel
	...
	private ComboBox slAllapproval=new ComboBox("Are all approvals required are received");
	...
	private Logger logger = Logger.getLogger(SyndConstructionBuilding.class);
	public SyndConstructionBuilding() {
...
*/
	...
	void saveAreaDetailsofProperty() {
		...
		obj.setLastUpdatedBy(loginusername);
		beanareadetails.saveorUpdateSynPropAreaDtls(obj);
		uiflowdata.getAreaDetails1().add(obj);
	...
	void saveDetailsOfConstruction(){
	...
	void editDetailsOfConstruction(){
		try{
...
void editExtraItems(){
	...
	private void editNewPlanApprovalDetails() {
		try {
