...
public class ValoLightTheme extends Theme {
	...
	protected final static SolidColor TITLE_COLOR = new SolidColor(25, 125, 225);
	protected final static SolidColor TOOLTIP_TEXT_COLOR = new SolidColor(51, 51, 51);
	protected final static SolidColor TOOLTIP_BACKGROUND_COLOR = new SolidColor(255, 255, 255);
	protected final static SolidColor SUBTITLE_COLOR = new SolidColor(128, 128, 128);
	protected final static SolidColor LINE_COLOR = new SolidColor(223, 223, 223);
	protected final static SolidColor TEXT_COLOR = new SolidColor(128, 128, 128);
	protected final static SolidColor GRID_COLOR = new SolidColor(250, 250, 250);
	protected final static SolidColor LABEL_COLOR = new SolidColor(128, 128, 128);
	protected final static SolidColor BGCOLOR = new SolidColor(255, 255, 255);
	protected final static SolidColor BGCOLOR_LIGHT_GRAY = new SolidColor(0, 0, 0, 0.90);
	protected final static SolidColor TRANSPARENT_COLOR = new SolidColor(255, 255, 255, 0.0);
	...
	public ValoLightTheme() {
		setColors(COLOR1, COLOR2, COLOR3, COLOR4, COLOR5, COLOR6, COLOR7, COLOR8, COLOR9, COLOR10, COLOR11, COLOR12,
