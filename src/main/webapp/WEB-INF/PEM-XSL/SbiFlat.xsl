  ...
  <xsl:attribute name="value">
	...
	<p style="text-indent: 20px;text-align:justify;">
		...
		<p style="line-height: 100%;margin :1;">
				...
				<table width="100%">
					<tr>
						<th align="left" width="60%">Value of construction as on date as per agreement including undivided share of land</th>
						<td>:</td>
						Rs. <td width="39%"> <xsl:value-of select="uiFlowData/guidelinevalue" /></td>
					</tr>
					<tr>
						<th align="left" width="60%">Value of construction as on date as at site including undivided share of land</th>
						<td >:</td>
						Rs. <td width="39%"><xsl:value-of select="uiFlowData/marketValue" /></td>
					</tr>
				</table>
			<p style="margin :0;">
		...
		<table width="100%">
				...
				<p align="left" style="color:black;font-size:16;font-weight:bold;"><u>I.DETAILS OF APARTMENT BUILDING-UNDER CONSTRUCTION</u></p>
				<table width="100%">
					...
					<xsl:for-each select="uiFlowData/detailsBuilding2">
						<tr>
							<td width="2%"  style="text-align:left;vertical-align:top;"><xsl:number format="1)" value="position()+4"/></td>
							<td width="45%" style="text-align:left;vertical-align:top;">
								<xsl:value-of select="fieldLabel"></xsl:value-of>
							</td>
							<td width="3%" style="text-align:left;vertical-align:top;">:</td>
				...
				<br/>
		<!--FLAT VALUATION -->
				<p align="left" style="color:black;font-size:16;font-weight:bold;"><u>II. FLAT UNDER VALUATION</u></p>
				<table width="100%">
			...
			<p align="left" style="color:black;font-size:16;font-weight:bold;"><u>III. DETAILS OF PLAN APPROVAL</u></p>
				<table width="100%">
			...
			<p align="left" style="color:black;font-size:16;font-weight:bold;"><u>IV.VALUATION OF UNDER CONSTRUCTION</u></p>
				<table width="100%">
				...
				<table width="100%"
					...
					<tr>
						...
						<td align="left" style=" border-bottom: 1px solid black;">
							<xsl:value-of select="uiFlowData/guidelinevalue" />
						</td>
					</tr>
					<tr>
						<td align="left"
