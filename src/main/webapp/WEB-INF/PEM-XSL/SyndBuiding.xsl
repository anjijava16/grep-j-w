  ...
  <xsl:attribute name="value">
      <xsl:value-of select="uiFlowData/evalnumber"/>
		...
		<p style="line-height: 100%;margin :0;">
			...
			<p align="left" style="color:black;font-size:16;font-weight:bold;margin:0;text-decoration:underline;">I.	DETAILS OF BUILDING PLAN APPROVAL : </p>				
				<table width="100%">
				...
				<br />
				<!--BUILD VALUATION -->
				<p align="left" style="color:black;font-size:16;font-weight:bold;margin:0;text-decoration:underline;">II. TECHNICAL DETAILS OF THE BUILDING</p>
				<table width="100%">
	...
	<!--SPECIFICATION OF BUILDING -->
			...
			<table width="100%" style="border-top:1px solid black;padding:5px;table-layout : fixed">
				...
				<table width="100%">
					...
					<xsl:for-each select="uiFlowData/miscellaneous">
						<tr>
							<td width="2%"  style="text-align:left;vertical-align:top;"><xsl:number value="position()+0" format="1)" /></td>
							<td width="45%" style="text-align:left;vertical-align:top;">
								<xsl:value-of select="fieldLabel"></xsl:value-of>
					...
					<xsl:if test="uiFlowData/miscellaneous/fieldLabel[.!='']">
						<tr>
						<td width="2%"></td>
						<td width="45%">Total</td>
						<td width="3%" style="text-align:left;vertical-align:top;">:</td>
				...
				<p align="right"  style="font-weight:bold;">(<xsl:value-of select="uiFlowData/signature" />)</p>
				<p align="left" style="margin:0;">Note: The guideline value of the property was obtained from the</p>
				...
				<br />
				<br />
				<p align="right">(<xsl:value-of select="uiFlowData/signature" />)</p>
