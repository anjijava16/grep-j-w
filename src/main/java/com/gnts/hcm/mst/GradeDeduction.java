...
public class GradeDeduction extends BaseUI {
	...
	private void loadSrchRslt() {
		try {
			...
			listGradeEarning = serviceGradeDeduction.getGradeEarnList(null, gradeId, earnId,
			...
			tblMstScrSrchRslt.setColumnHeaders(new String[] { "Ref.Id", "Grade Name", "Deduction Name", "Status",
