    ...
    <xsl:value-of select="uiFlowData/evalnumber"/>
				...
				<center>
					<p style="text-transform:uppercase;align:centre">
						<u>
							<b>
								PROGRESS REPORT TOWARDS THE UNDER CONSTRUCTION OF
				...
				<table width="100%" style="table-layout : fixed;border-top:1px solid black;border-left:1px solid black; border-right:1px solid black;padding:5px; ">
					<tr>
						<th align="left" style=" border-bottom: 1px solid black;border-right: 1px solid black;">Present Fair Market Value of property</th>
					...
					<tr>
						...
						<td width="49%"  style="border-bottom: 1px solid black;">Yet to be started</td>
					</tr>
				</table>
			<p style="margin :0;">
		...
		<table width="100%">
				...
				<table width="100%">
					<xsl:for-each select="uiFlowData/propertyConstruct5">
						<tr>
				...
				<table width="100%">
					...
					<xsl:for-each select="uiFlowData/propertyOccupancy1">
						<tr>
							<td width="2%"  style="text-align:left;vertical-align:top;"></td>
							<td width="45%" style="text-align:left;vertical-align:top;">
								<xsl:value-of select="fieldLabel"></xsl:value-of>
					...
					<xsl:for-each select="uiFlowData/propertyOccupancy2">
						<tr>
					...
					<xsl:for-each select="uiFlowData/propertyOccupancy3">
						<tr>
							<td width="2%"  style="text-align:left;vertical-align:top;"></td>
							<td width="45%" style="text-align:left;vertical-align:top;">
								<xsl:value-of select="fieldLabel"></xsl:value-of>
					...
					<xsl:for-each select="uiFlowData/propertyOccupancy4">
						<tr>
...
<!--SPECIFICATION OF BUILDING(EXISTING) -->
			...
			<p align="left" style="color:black;font-size:16;font-weight:bold;margin:0;text-decoration:underline;">I.	DETAILS OF PLAN APPROVAL : </p>				
				...
				<table width="100%">
				<td width="2%">9)</td>
				<td width="45%">Specifications of the building</td>
				<td width="3%"></td>
				<td width="45%"></td>
				</table>
				<table width="100%">
				<xsl:for-each select="uiFlowData/buildSpec2">
					<xsl:if test="position() != last()">
							<xsl:if test="(position() mod 8)=1">
								<tr>
									<td align="left" style="font-weight:bold;text-decoration:underline;">Description</td>
